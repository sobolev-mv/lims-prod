...
namespace Viz.WrkModule.Qc.Db.DataSets
{
  ...
  {
    public class TypeUstDataTable : DataTable
    {
      protected readonly OracleDataAdapter adapter;

      public TypeUstDataTable(string tblName) : base()
      {
        ...
        var dtm = new System.Data.Common.DataTableMapping("VIZ_PRN.QMF_TYPE_UST", tblName);
        ...
        adapter.SelectCommand = new OracleCommand
        {
          ...
          CommandText = "SELECT ID, NAME FROM VIZ_PRN.QMF_TYPE_UST ORDER BY 1",
