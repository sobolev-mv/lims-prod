...
namespace Viz.WrkModule.Qc.Db.DataSets
{
  ...
  {
    public class TypeFqDataTable : DataTable
    {
      protected readonly OracleDataAdapter adapter;

      public TypeFqDataTable(string tblName) : base()
      {
        ...
        var dtm = new System.Data.Common.DataTableMapping("VIZ_PRN.QMF_TYPE_FQ", tblName);
        ...
        adapter.SelectCommand = new OracleCommand
        {
          ...
          CommandText = "SELECT ID, NAME FROM VIZ_PRN.QMF_TYPE_FQ ORDER BY 1",
