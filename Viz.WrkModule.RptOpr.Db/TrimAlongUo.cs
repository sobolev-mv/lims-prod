...
{
  public sealed class TrimAlongUoRptParam : Smv.Xls.XlsInstanceParam
  {
    public DateTime DateBegin { get; set; }
    public DateTime DateEnd { get; set; }
    public TrimAlongUoRptParam(string sourceXlsFile, string destXlsFile) : base(sourceXlsFile, destXlsFile)
    {}
  }

  public sealed class TrimAlongUo : Smv.Xls.XlsRpt
  {

    protected override void DoWorkXls(object sender, DoWorkEventArgs e)
    {
      var prm = (e.Argument as TrimAlongUoRptParam);
    ...
    private Boolean RunRpt(TrimAlongUoRptParam prm, dynamic CurrentWrkSheet)
    {
